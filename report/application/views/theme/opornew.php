        ...
        <hr /><br />
             <table width="100%" cellspacing="0" cellpadding="0" id="datatable" class="hovered bordered striped">
                ...
                <tbody><tr>
                    ...
                    <th width="160">Ubicación</th>

                    <th width="100">Comentario</th>

                                        <th width="100">Monto</th>
                                                            <th width="100">Probabilidad</th>
...
<th></th>
                ...
                <tr style="background-color: rgb(251, 251, 251);">
                    ...
                    <td><?php
                       ...
                       <td><?php echo $val['prob']*100;?></td>

                       <td><button  onclick="process(<?php echo $val['id'];?>,'¿Desea ingresar esta oportunidad al proceso de ventas?')" class="bg-color-blue">Procesar</button></td>
 ...
 $.Dialog({
            ...
            'buttons'     : {
                'No ingresar'     : {
                    'action': function(){
                        $.ajax({
                            url: "<?=$baseurl?>/opor/ChangeState/"+id+"/NewClosed",
                            success:function(){
                                location.href="<?=$baseurl?>/opor/nuevas";
                            }
                        });
                    }
                },
                'Ingresar'     : {
                    'action': function(){
                        $.ajax({
                            url: "<?=$baseurl?>/opor/ChangeState/"+id+"/Process",
                            success:function(){
                                location.href="<?=$baseurl?>/opor/nuevas";
                            }
                        });
